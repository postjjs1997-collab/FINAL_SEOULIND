...
const expandedPageConfigs: Record<string, PageConfig> = {
  ...
  "products/electric-vehicle": {
    ...
    lead: "전동화 구동계의 윤활 계통과 동력 전달 계통에 들어가는 알루미늄 가공 부품과 샤프트를 시제품부터 양산까지 대응합니다.",
...
const expandedPageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/electric-vehicle": {
      ...
      eyebrow: "EV / HEV / PHEV / BEV",
      title: "ELECTRIFIED POWERTRAIN",
      lead: "We supply machined-aluminum parts and shafts for the lubrication and power-transfer systems of electrified drivetrains, from prototypes through series production.",
  ...
  ja: {
    ...
    "products/electric-vehicle": {
      ...
      eyebrow: "EV / HEV / PHEV / BEV",
      title: "ELECTRIFIED POWERTRAIN",
      lead: "電動化ドライブトレインの潤滑系と動力伝達系に用いるアルミ加工部品とシャフトに、試作から量産まで対応します。",
