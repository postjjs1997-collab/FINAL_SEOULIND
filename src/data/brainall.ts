...
import clientDauchImage from "../../assets/clients/client-dauch.jpg";
...
const partnerMarks = [
  { name: "Dauch Corporation", mark: "DAUCH", logoSrc: partnerLogoUrls.dauch, region: "USA" },
