...
export const productEvidenceByRoute: Record<string, ProductEvidence> = {
  ...
  "products/powertrain": {
    ...
    title: {
      ko: "엔진과 감속기의 회전계 정밀부품",
      en: "Precision rotating parts for engines and reduction systems",
      ja: "エンジンと減速機の回転系精密部品",
    },
    copy: {
  ...
  "products/driveline": {
    ...
    copy: {
      ko: "8L90·10R Transmission Shaft, Transfer Case Actuator Shaft와 10R TRS Stator Shaft 계열을 생산합니다.",
      en: "Production includes 8L90 and 10R transmission shafts, transfer-case actuator shafts, and 10R TRS stator shafts.",
      ja: "8L90・10R Transmission Shaft、Transfer Case Actuator Shaft、10R TRS Stator Shaftを生産します。",
    },
    items: {
      ko: ["8L90 Transmission Shaft", "10R Transmission Shaft", "Transfer Case Actuator Shaft", "10R TRS Stator Shaft"],
      en: ["8L90 transmission shaft", "10R transmission shaft", "Transfer-case actuator shaft", "10R TRS stator shaft"],
      ja: ["8L90 Transmission Shaft", "10R Transmission Shaft", "Transfer Case Actuator Shaft", "10R TRS Stator Shaft"],
    },
