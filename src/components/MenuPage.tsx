...
const expandedPageConfigs: Record<string, PageConfig> = {
  ...
  "products/electric-vehicle": {
    ...
    lead: "EV 감속기 윤활 시스템용 오일 펌프 하우징·커버를 정밀가공하고, 전동화용 기어 샤프트·코액시얼 샤프트·링크 샤프트의 설계 검토와 시제품 제작·검증에 대응합니다.",
  ...
  "products/powertrain": {
    ...
    title: "POWERTRAIN",
    lead: "변속기용 샤프트와 엔진용 캠샤프트 노즈 피스·밸런스 샤프트 등 정밀 가공 부품을 생산합니다.",
  ...
  "products/driveline": {
    ...
    title: "DRIVELINE",
    lead: "트랜스퍼 케이스와 ETM용 디스크 캐리어, 허브, 액추에이터 샤프트를 생산합니다.",
    heroCopy: "호빙·브로칭·랙 롤링·레이저 용접을 제품 형상에 맞춰 적용하고, 치형·스플라인 및 용접부를 승인 도면 기준으로 관리합니다.",
  ...
  "products/balance-shaft-module": {
    ...
    lead: "밸런스 샤프트 모듈용 알루미늄 하우징과 오일 펌프용 알루미늄 부품을 정밀가공합니다.",
  ...
  "products/steering": {
    ...
    title: "STEERING",
    lead: "피니언, 피니언 샤프트, 피스톤, 랙 부시, 토션 바 등 조향 장치에 적용되는 정밀 가공 부품을 생산합니다.",
  ...
  "products/etc": {
    ...
    heroCopy: "구체적인 대응 범위와 관리 기준은 보안 및 고객 승인 조건에 따라 개별 협의합니다.",
...
const expandedPageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/electric-vehicle": { groupTitle: "Products", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "We precision-machine oil-pump housings and covers for EV reduction-gear lubrication systems and support design reviews, prototype production, and validation for electrified-powertrain gear shafts, coaxial shafts, and link shafts.", heroCopy: "At each product approval stage, we control oil passages and bearing bores in housings and covers, along with gear and spline geometry, runout, and surface condition on shafts." },
    "products/powertrain": { groupTitle: "Products", eyebrow: "Transmission & Engine", title: "POWERTRAIN", lead: "We produce precision-machined transmission shafts and engine components, including camshaft nose pieces and balance shafts.", heroCopy: "Gear and spline geometry, bearing seats, runout, and surface condition are controlled to product-specific process criteria." },
    "products/driveline": { groupTitle: "Products", eyebrow: "Transfer Case / ETM", title: "DRIVELINE", lead: "We produce disc carriers, hubs, and actuator shafts for transfer cases and ETM systems.", heroCopy: "Hobbing, broaching, rack rolling, and laser welding are selected to suit each part geometry; tooth profiles, splines, and welds are controlled against approved drawings." },
    "products/balance-shaft-module": { groupTitle: "Products", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "We precision-machine aluminum housings and aluminum components for oil pumps used in balance-shaft modules.", heroCopy: "Oil passages, bearing bores, assembly faces, and complex geometry are machined and inspected against dimensional and geometric requirements on approved drawings." },
    "products/steering": { groupTitle: "Products", eyebrow: "Steering Assembly Parts", title: "STEERING", lead: "We produce precision-machined components for steering systems, including pinions, pinion shafts, pistons, rack bushes, and torsion bars.", heroCopy: "Helical-gear and spline geometry, heat-treatment condition, and shaft runout are controlled at each process stage against customer-approved drawing requirements." },
    "products/etc": { groupTitle: "Products", eyebrow: "DEFENSE & SPECIAL PROJECTS", title: "DEFENSE", lead: "Public disclosure of information related to defense and special projects is restricted.", heroCopy: "Specific project scope and control requirements are agreed case by case according to security and customer-approval conditions." },
  ...
  ja: {
    ...
    "products/electric-vehicle": { groupTitle: "製品情報", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "EV減速機の潤滑システム向けオイルポンプハウジング／カバーを精密加工し、電動化パワートレイン向けギヤシャフト、コアキシャルシャフト、リンクシャフトの設計検討・試作品の製作・検証に対応します。", heroCopy: "製品ごとの承認段階に応じて、ハウジング／カバーのオイル流路・ベアリングボアと、シャフトのギヤ・スプライン形状、振れ、表面状態を管理します。" },
    "products/powertrain": { groupTitle: "製品情報", eyebrow: "Transmission & Engine", title: "POWERTRAIN", lead: "トランスミッション用シャフトと、カムシャフトノーズピース、バランスシャフトなどのエンジン用精密加工部品を生産します。", heroCopy: "ギヤ・スプライン形状、ベアリング取付面、振れ、表面状態を製品別の工程基準に従って管理します。" },
    "products/driveline": { groupTitle: "製品情報", eyebrow: "Transfer Case / ETM", title: "DRIVELINE", lead: "トランスファーケースおよびETM向けディスクキャリア、ハブ、アクチュエーターシャフトを生産します。", heroCopy: "ホブ加工、ブローチ加工、ラック転造、レーザー溶接を製品形状に応じて適用し、歯形・スプライン・溶接部を承認図面に基づいて管理します。" },
    "products/balance-shaft-module": { groupTitle: "製品情報", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "バランスシャフトモジュール向けアルミハウジングとオイルポンプ用アルミ部品を精密加工します。", heroCopy: "オイル流路、ベアリングボア、組立面、複合形状を、承認図面の寸法・幾何公差要求に基づいて加工・検査します。" },
    "products/steering": { groupTitle: "製品情報", eyebrow: "Steering Assembly Parts", title: "STEERING", lead: "ピニオン、ピニオンシャフト、ピストン、ラックブッシュ、トーションバーなど、ステアリングシステムに使用される精密加工部品を生産します。", heroCopy: "ヘリカルギヤ・スプライン形状、熱処理状態、シャフトの振れを、顧客承認図面の要求事項に基づいて工程ごとに管理します。" },
    "products/etc": { groupTitle: "製品情報", eyebrow: "DEFENSE & SPECIAL PROJECTS", title: "DEFENSE", lead: "防衛・特別プロジェクトに関する情報は、対外公開の範囲を限定します。", heroCopy: "具体的な対応範囲と管理基準は、セキュリティおよび顧客承認条件に応じて個別に協議します。" },
