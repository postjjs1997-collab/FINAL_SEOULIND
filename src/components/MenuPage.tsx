...
const expandedPageConfigs: Record<string, PageConfig> = {
  ...
  "products/electric-vehicle": {
    ...
    lead: "EV 감속기 윤활 시스템용 오일 펌프 하우징·커버를 정밀가공하고, HEV·PHEV·BEV용 기어·코액시얼·링크 샤프트의 설계 검토와 시제품 검증에 대응합니다.",
    heroCopy: "제품별 승인 단계에 맞춰 하우징·커버의 오일 유로와 베어링 보어, 샤프트의 기어·스플라인 형상·런아웃·표면 상태를 관리합니다.",
  ...
  "products/powertrain": {
    ...
    title: "POWERTRAIN",
    lead: "변속기·엔진용 샤프트, 캠샤프트 노즈 피스, 밸런스 샤프트 계열 부품을 생산해 토크와 동력 전달을 지원합니다.",
  ...
  "products/driveline": {
    ...
    title: "DRIVELINE",
    lead: "트랜스퍼 케이스와 ETM용 디스크 캐리어, 허브, 액추에이터 샤프트 계열을 생산합니다.",
    heroCopy: "호빙, 브로칭, 랙 롤링과 레이저 용접 공정을 연결해 동력 배분과 AWD 제어 부품의 조립 신뢰성을 높입니다.",
  ...
  "products/balance-shaft-module": {
    ...
    lead: "밸런스 샤프트 모듈용 알루미늄 하우징과 오일 펌프를 정밀가공합니다.",
    heroCopy: "알루미늄 주조 부품의 유로, 베어링 보어, 조립면과 복합 형상을 관리해 BSM의 조립성과 기능 품질을 확보합니다.",
  ...
  "products/steering": {
    ...
    title: "STEERING",
    lead: "피니언, 피니언 샤프트, 피스톤, 랙 부시, 토션 바 등 조향 장치의 핵심 기능 부품을 생산합니다.",
  ...
  "products/etc": {
    ...
    title: "DEFENSE",
    lead: "서울산업은 방산을 포함해 정보 관리가 요구되는 프로젝트를 위한 정밀가공·품질관리 역량을 갖추고 있습니다.",
    heroCopy: "고객·제품·형상·적용 정보는 공개하지 않으며, 도면 검토부터 공정 설계, 생산 품질, LOT 추적까지 승인된 절차에 따라 관리합니다.",
...
const expandedPageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/electric-vehicle": { groupTitle: "Products", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "We precision-machine oil-pump housings and covers for EV reducer lubrication systems, and support design review and prototype validation for gear, coaxial, and link shafts used in HEV, PHEV, and BEV platforms.", heroCopy: "At each product approval stage, we control oil passages and bearing bores in housings and covers, as well as gear and spline geometry, runout, and surface condition on shafts." },
    "products/powertrain": { groupTitle: "Products", eyebrow: "Transmission & Engine", title: "POWERTRAIN", lead: "We produce transmission shafts, camshaft nose pieces, and balance-shaft families that support torque delivery in transmissions and engines.", heroCopy: "Gear and spline geometry, bearing seats, runout, and surface integrity are controlled for repeatable production quality." },
    "products/driveline": { groupTitle: "Products", eyebrow: "Transfer Case / ETM", title: "DRIVELINE", lead: "We produce disk carriers, hubs, and actuator shafts for transfer-case and electronic torque-management systems.", heroCopy: "Hobbing, broaching, rack rolling, and laser-welding processes support reliable torque distribution and AWD control." },
    "products/balance-shaft-module": { groupTitle: "Products", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "We precision-machine aluminum housings and oil pumps for balance-shaft modules.", heroCopy: "Oil passages, bearing bores, assembly faces, and complex aluminum geometry are controlled for BSM assembly and functional quality." },
  ...
  ja: {
    ...
    "products/electric-vehicle": { groupTitle: "製品情報", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "EV減速機の潤滑システム向けオイルポンプハウジング／カバーを精密加工し、HEV・PHEV・BEV向けギヤ、コアキシャル、リンクシャフトの設計検討と試作検証に対応します。", heroCopy: "製品ごとの承認段階に合わせて、ハウジング／カバーのオイル流路とベアリングボア、シャフトのギヤ・スプライン形状、振れ、表面状態を管理します。" },
    "products/powertrain": { groupTitle: "製品情報", eyebrow: "Transmission & Engine", title: "POWERTRAIN", lead: "トランスミッション・エンジン向けシャフト、カムシャフトノーズピース、バランスシャフト部品を生産し、トルクと動力の伝達を支えます。", heroCopy: "ギヤ・スプライン形状、ベアリング取付面、振れ、表面健全性を工程ごとに管理し、量産品質を確保します。" },
    "products/driveline": { groupTitle: "製品情報", eyebrow: "Transfer Case / ETM", title: "DRIVELINE", lead: "トランスファーケースおよびETM向けディスクキャリア、ハブ、アクチュエーターシャフト部品を生産します。", heroCopy: "ホブ加工、ブローチ加工、ラックローリング、レーザー溶接をつなぎ、トルク配分とAWD制御部品の組立信頼性を高めます。" },
    "products/balance-shaft-module": { groupTitle: "製品情報", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "バランスシャフトモジュール向けアルミハウジングとオイルポンプを精密加工します。", heroCopy: "アルミ鋳造部品の流路、ベアリングボア、組立面、複合形状を管理し、BSMの組立性と機能品質を確保します。" },
    "products/steering": { groupTitle: "製品情報", eyebrow: "Steering Assembly Parts", title: "STEERING", lead: "ピニオン、ピニオンシャフト、ピストン、ラックブッシュ、トーションバーなど、ステアリングアセンブリの主要機能部品を生産します。", heroCopy: "ヘリカルギヤ・スプライン加工、熱処理、矯正、振れ検査をつなぎ、操舵入力を正確に伝えます。" },
    "products/etc": { groupTitle: "製品情報", eyebrow: "DEFENSE & SPECIAL PROJECTS", title: "DEFENSE", lead: "ソウル産業は、防衛分野を含む情報管理が求められるプロジェクトに向けた精密加工・品質管理体制を整えています。", heroCopy: "顧客、製品、形状、用途に関する情報は公開せず、図面検討、工程設計、生産品質、ロットトレーサビリティを承認された手順に基づいて管理します。" },
