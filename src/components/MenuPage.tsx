...
const pageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/automotive": {
      ...
      lead: "Three core families—Steering, Powertrain, and Driveline—are extended by electrified parts and machined aluminum components.",
...
const expandedPageConfigs: Record<string, PageConfig> = {
  ...
  "products/electric-vehicle": {
    ...
    lead: "전동화 구동계의 윤활 계통과 동력 전달 계통에 들어가는 알루미늄 가공품 및 샤프트 개발품에 대응합니다.",
  ...
  "products/balance-shaft-module": {
    ...
    lead: "알루미늄 주조 소재를 기능면 가공과 검사까지 연결해 모듈용 정밀 부품으로 완성합니다.",
  ...
  "products/etc": {
    ...
    title: "DEFENSE",
    lead: "방산·특수 프로젝트 관련 정보는 대외 공개 범위를 제한합니다.",
  ...
  "quality/preventive": {
    ...
    title: "예방 품질 활동",
    lead: "문제가 발생한 뒤 대응하는 품질을 넘어, 개발과 양산 준비 단계에서 위험 요인을 먼저 제거합니다.",
...
const expandedPageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/electric-vehicle": {
      ...
      eyebrow: "EV / HEV / PHEV / BEV",
      title: "ELECTRIFIED POWERTRAIN",
      lead: "We support machined aluminum parts and development-stage shafts used in lubrication and power-transfer systems for electrified drivetrains.",
    ...
    "products/powertrain": {
      ...
      eyebrow: "Transmission & Engine",
      title: "POWERTRAIN",
      lead: "We produce long, hollow, and integral-gear shafts plus interface components for transmission and engine systems.",
    ...
    "products/steering": {
      ...
      introCopy: "Rack-and-pinion steering converts steering-wheel rotation into linear rack motion to change wheel direction. Seoul Industry precision-machines shafts, pistons, and bushes used in this mechanism.",
    },
  ...
  ja: {
    ...
    "company/ceo": { groupTitle: "企業情報", title: "CEOメッセージ", lead: "お客様の信頼を基盤に、持続可能な成長を追求します。", heroCopy: "「調和から創造する企業」という経営理念のもと、最高の品質で社会に貢献するグローバルリーダーを目指します。" },
    ...
    "company/notices": { groupTitle: "企業情報", title: "お知らせ", lead: "製品、品質、採用、企業活動に関するソウル産業の主要情報をご覧いただけます。", heroCopy: "お客様とサプライヤーに必要な会社情報を正確かつ迅速にお伝えします。" },
    "products/electric-vehicle": {
      groupTitle: "製品情報",
      eyebrow: "EV / HEV / PHEV / BEV",
      title: "ELECTRIFIED POWERTRAIN",
    ...
    "products/driveline": {
      ...
      eyebrow: "Transfer Case / ETM",
      title: "DRIVELINE",
      lead: "電子制御AWD・トランスファーケース系に用いる歯形部品と溶接アセンブリを生産します。",
    ...
    "products/etc": { groupTitle: "製品情報", eyebrow: "DEFENSE & SPECIAL PROJECTS", title: "DEFENSE", lead: "防衛・特別プロジェクトに関する情報は、対外公開の範囲を限定します。", heroCopy: "お問い合わせごとに素材、形状、公差、検証項目を確認したうえで、製造対応範囲を検討します。" },
