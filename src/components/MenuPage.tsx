...
const expandedPageConfigs: Record<string, PageConfig> = {
  ...
  "products/electric-vehicle": {
    ...
    heroCopy: "알루미늄 하우징·커버와 개발·검증 샤프트를 제품별 승인 단계에 맞춰 오일 유로·베어링 보어, 기어·스플라인 형상, 런아웃과 표면 기준으로 관리합니다.",
  ...
  "products/balance-shaft-module": {
    ...
    lead: "BALANCE SHAFT MODULE용 알루미늄 HOUSING과 OIL PUMP를 정밀가공합니다.",
...
const expandedPageConfigTranslations: Record<Exclude<LanguageCode, "ko">, Record<string, Partial<PageConfig>>> = {
  en: {
    ...
    "products/electric-vehicle": { groupTitle: "Products", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "We precision-machine oil-pump housings and covers for EV reducer lubrication systems, and support design review and prototype validation for gear, coaxial, and link shafts used in HEV, PHEV, and BEV platforms.", heroCopy: "Aluminum housings and covers, together with development-validation shafts, are managed by product approval stage across oil passages, bearing bores, gear and spline geometry, runout, and surface condition." },
    ...
    "products/balance-shaft-module": { groupTitle: "Products", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "Machined aluminum housings and oil pumps for balance-shaft modules.", heroCopy: "Oil passages, bearing bores, assembly faces, and complex aluminum geometry are controlled for BSM assembly and functional quality." },
  ...
  ja: {
    ...
    "products/electric-vehicle": { groupTitle: "製品情報", eyebrow: "EV / HEV / PHEV / BEV", title: "ELECTRIFIED POWERTRAIN", lead: "EV減速機の潤滑システム向けオイルポンプハウジング／カバーを精密加工し、HEV・PHEV・BEV向けギヤ、コアキシャル、リンクシャフトの設計検討と試作検証に対応します。", heroCopy: "アルミハウジング／カバーと開発・検証用シャフトを、製品ごとの承認段階に合わせ、オイル流路、ベアリングボア、ギヤ・スプライン形状、振れ、表面基準で管理します。" },
    ...
    "products/balance-shaft-module": { groupTitle: "製品情報", eyebrow: "Machined Aluminum", title: "MACHINED ALUMINUM COMPONENTS", lead: "BALANCE SHAFT MODULE向けアルミHOUSINGとOIL PUMPを精密加工します。", heroCopy: "アルミ鋳造部品の流路、ベアリングボア、組立面、複合形状を管理し、BSMの組立性と機能品質を確保します。" },
    ...
    "products/etc": { groupTitle: "製品情報", eyebrow: "DEFENSE & SPECIAL PROJECTS", title: "DEFENSE", lead: "ソウル産業は、防衛分野を含む情報管理が求められるプロジェクトに向けた精密加工・品質管理体制を整えています。", heroCopy: "顧客、製品、形状、用途に関する情報は公開せず、図面検討、工程設計、生産品質、LOTトレーサビリティを承認された手順に基づいて管理します。" },
    ...
    "quality/system": { groupTitle: "品質保証", title: "品質システム", lead: "図面検討、受入検査、工程検査、最終検査、LOT追跡を一つの品質フローで運営します。", heroCopy: "IATF 16949、ISO 14001、MSQと顧客品質基準を日常の工程管理につなげます。" },
