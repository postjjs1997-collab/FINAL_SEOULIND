...
const noticePageCopy: Record<LanguageCode, NoticePageCopy> = {
  ...
  en: {
    ...
    heroCopy: "Review company notices covering product programs, development response, quality control, and production flow.",
...
const newsPageCopy: Record<LanguageCode, NoticePageCopy> = {
  ...
  en: {
    ...
    heroEyebrow: "SEOULIND NEWS",
    heroTitle: "NEWS",
    heroCopy: "Read updates on Seoul Industry products, manufacturing processes, quality response, and global OEM partnerships.",
