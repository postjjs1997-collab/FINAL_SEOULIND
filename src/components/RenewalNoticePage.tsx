...
const noticeCopy: Record<RenewalLanguage, NoticeCopy> = {
  ko: {
    ...
    loginTitle: "공지사항 관리",
    loginDescription: "관리자 계정으로 로그인하면 게시글 작성·수정·게시 중지·삭제를 관리할 수 있습니다.",
    id: "관리자 아이디",
    password: "비밀번호",
    login: "로그인",
    ...
    uploadImage: "이미지 업로드",
    uploading: "업로드 중...",
    uploaded: "이미지가 업로드되었습니다. 게시글 저장 버튼을 눌러 반영해 주세요.",
    removeImage: "이미지 삭제",
    titleLabel: "제목",
    summary: "요약",
    body: "본문",
  ...
  ja: {
    ...
    loginTitle: "お知らせ管理",
    loginDescription: "管理者アカウントでログインすると、記事の作成・編集・非公開化・削除ができます。",
    id: "管理者ID",
    password: "パスワード",
    login: "ログイン",
